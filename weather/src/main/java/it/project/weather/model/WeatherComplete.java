...
public class WeatherComplete extends Weather {
	...
	public WeatherComplete(double temp_max, double temp_min, String date, String main_weather, String description, short humidity, double clouds, double wind_speed, short wind_deg, String wind_type, double rain, double snow, short visibility, double temp_current, double temp_feelslike, double pop_rain) 
	{
